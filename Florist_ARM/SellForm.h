...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox_sell->Items->AddRange(gcnew cli::array< System::Object^  >(4) { L"Альстромерия", L"Гвоздика", L"Лилия", L"Роза кустовая" });
...
#pragma endregion
// кнопка выхода из формы продажи
...
// кнопка сохранения продажи
	private: System::Void btn_save_Click(System::Object^ sender, System::EventArgs^ e) {
		String^ position = comboBox_sell->Text; // товар
		int count = Convert::ToInt32(numeric_sell->Value); // количество
		...
		DateTime^ selected_date = dtp_sell->Value; // запоминаем дату
