...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox_order->Items->AddRange(gcnew cli::array< System::Object^  >(4) { L"Альстромерия", L"Гвоздика", L"Лилия", L"Роза кустовая" });
...
// кнопка сохранения заказа
	private: System::Void btn_save_Click(System::Object^ sender, System::EventArgs^ e) {
		String^ position = comboBox_order->Text; // товар
		int count = Convert::ToInt32(numeric_order->Value); // количество
		...
		DateTime^ selected_date = dtp_order->Value; // запоминаем дату
